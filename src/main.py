...
def live_desktop_plot(app):
    ...
    print("---Quant Guild Desktop Live Implied Volatility Surface Start---")
        ...
        while True:
            if not state.is_locked:
                ...
                if len(current_data) > 10:
                    ...
                    current_elev, current_azim = ax_3d.elev, ax_3d.azim
                    ...
                    ax_skew.set_title(f"FRONT_MONTH SKEW {nearest_exp}", color='white')
                    ax_skew.axvlines(x=app.spot_price, color="#ff3e3e", linestyle='--')
